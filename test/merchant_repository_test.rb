...
class MerchantRepositoryTest < Minitest::Test
  ...
  def setup
    @engine = mock
    # @dummy_repo = MerchantRepository.new('./data/merchants.csv', @engine)
  ...
  #
  # def test_find_by_id
  #   assert_instance_of Merchants, @dummy_repo.find_by_id(12334141)
  ...
  def test_it_can_delete_items
    ...
    @dummy_repo.create(data)
    @dummy_repo.delete(12334142)
    assert_nil nil, @dummy_repo.find_by_id(12334142)
  end
